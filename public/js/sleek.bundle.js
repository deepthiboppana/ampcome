;(function (global, factory) {
  ...
  jquery =
    jquery && jquery.hasOwnProperty('default') ? jquery['default'] : jquery
  ...
  var bootstrap = createCommonjsModule(function (module, exports) {
    ...
    ;(function (global, factory) {
      ...
      $(window).on(Event$1.LOAD_DATA_API, function () {
        ...
        buttons = [].slice.call(
          document.querySelectorAll(Selector$1.DATA_TOGGLE),
        )
  ...
  $(document).ready(function () {
    ...
    if (activity !== null) {
      var activityData = [
        {
          first: [110, 185, 252, 185, 240, 325, 395],
          second: [130, 180, 280, 200, 260, 348, 381],
          third: [128, 225, 186, 268, 312, 227, 305],
        },
      ]
  ...
  ;(function () {
    $(document).ready(function () {
      ...
      $('.btn-close-right-sidebar-2').on('click', function () {
        jQuery('.right-sidebar-container-2').removeClass(
